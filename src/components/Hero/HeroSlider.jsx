...
const HeroSlider = () => {
    return (
            ...
            >
                <SwiperSlide><img src={image1} className='w-full h-full' alt="image1" /></SwiperSlide>
                <SwiperSlide><img src={image2} className='w-full h-full' alt="image2" /></SwiperSlide>
                <SwiperSlide><img src={image3} className='w-full h-full' alt="image3" /></SwiperSlide>
                ...
                <div className='absolute text-gray-900 top-1/2 -translate-y-1/2 left-16 z-50 flex flex-col justify-start items-start gap-8'>
                    ...
                    <button className='relative bg-gray-950 text-white px-5 py-4 rounded-full text-xl font-semibold hover:bg-blue-600 duration-100 '>
                        Show shop
                    </button>
