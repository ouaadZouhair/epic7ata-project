...
const cardData = [
    ...
    { id: 7, title: "Card 7", description: "This is card 7", price: 350 },
    { id: 8, title: "Card 8", description: "This is card 8", price: 350 },
];
            ...
            <div className="slider_sells overflow-hidden my-7">
                ...
                >
                    {cardData.map((card) => (
                        <div
                            key={card.id}
                            className="slide_sells bg-gray-100 rounded-xl w-[300px] h-[450px] shadow-sm border border-gray-50 overflow-hidden hover:scale-105 duration-100"
                        >
