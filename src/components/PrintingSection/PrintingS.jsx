...
const PrintingS = () => {
    return (
        <div className='flex justify-center items-center rounded-3xl w-[90%] h-[530px] overflow-hidden mx-auto shadow-xl bg-gray-950 hover:scale-105 my-10 duration-150 '>
            <div className="w-1/2 h-full flex flex-col justify-center items-center gap-10 text-white">
                ...
                <Link className='designBtn text-black font-medium' to='/print'>Design NOW!!</Link>
